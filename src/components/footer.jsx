    ...
    <footer className="py-10 sm:py-20 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h3 className="text-2xl font-bold">Savoria</h3>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Menu', 'Reservations', 'Events', 'Gift Cards', 'Careers'].map((link) => (
                <li key={link}>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <MapPin className="w-5 h-5" style={{ color: theme.colors.orange }} />
                <span className="text-gray-400 text-sm sm:text-base">123 Culinary Street, Food City, FC 12345</span>
              </div>
              <div className="flex items-center gap-3">
                <Phone className="w-5 h-5" style={{ color: theme.colors.orange }} />
                <span className="text-gray-400 text-sm sm:text-base">(555) 123-4567</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-gray-400">
          <p className="text-sm sm:text-base">&copy; 2025 Savoria Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
